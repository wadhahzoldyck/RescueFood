        ...
        <div class="row w-100 mx-0">
            <div class="col-lg-6 mx-auto">
                <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                    ...
                    <form class="pt-3" action="{{ route('recommandationsadmin.update', $recommandation->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="text-center mt-4 font-weight-light">
                            <a href="{{ route('recommandationsadmin.index') }}" class="text-primary">Retourner à la liste des recommandations</a>
                        </div>
                    </form>
                </div>
            </div>
